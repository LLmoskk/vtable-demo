...
const Demo5: React.FC = () => {
    ...
    // 应用所有行的统一行高
    const handleApplyRowHeight = () => {
        if (customRowHeight && tableInstance) {
    ...
    // 应用所有列的统一列宽
    const handleApplyColWidth = () => {
        if (customColWidth && tableInstance) {
            const width = parseInt(customColWidth);
            if (width > 0) {
                console.log('应用统一列宽:', width);
                // 更新默认列宽并重新渲染
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex items-center space-x-2">
                            <Input
                                ...
                                className="flex-1"
                            />
                            <Button size="sm" onClick={handleApplyRowHeight}>
                                应用
                            </Button>
                        </div>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex items-center space-x-2">
                            <Input
                                ...
                                className="flex-1"
                            />
                            <Button size="sm" onClick={handleApplyColWidth}>
                                应用
                            </Button>
                        </div>
                    </div>
                ...
                <div className="bg-white p-4 rounded-lg border shadow-sm">
                    <ListTable
                        ...
                        onReady={(instance: any) => {
                            console.log('表格实例已准备就绪:', instance);
